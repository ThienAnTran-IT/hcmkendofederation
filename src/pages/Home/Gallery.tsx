  ...
  <div>
    ...
    <div className="gallery-row"> 
      ...
      <div className="gallery-column">
        ...
        <img src={image4} style={{width: '100%'}} alt='image4' />
        <img src={image10} style={{width: '100%'}} alt='image10' />
        <img src={image13} style={{width: '100%', height: '201px'}} alt='image13' />
      </div>  
      <div className="gallery-column">
        <img src={image5} style={{width: '100%'}} alt='image5' />
        <img src={image6} style={{width: '100%'}} alt='image6' />
        <img src={image11} style={{width: '100%'}} alt='image11' />
      </div>
      <div className="gallery-column">
      <img src={image7} style={{width: '100%'}} alt='image7' />
      <img src={image8} style={{width: '100%'}} alt='image8' />
      <img src={image12} style={{width: '100%', height: '162px'}} alt='image12' />
      </div>
    </div>
  </div>
)
